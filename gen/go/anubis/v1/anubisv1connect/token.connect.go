...
const (
	...
	TokenServiceName = "anubis.v1.TokenService"
)
...
func NewTokenServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TokenServiceClient {
	...
	tokenServiceMethods := v1.File_anubis_v1_token_proto.Services().ByName("TokenService").Methods()
...
// Revoke calls anubis.v1.TokenService.Revoke.
func (c *tokenServiceClient) Revoke(ctx context.Context, req *connect.Request[v1.RevokeRequest]) (*connect.Response[v1.RevokeResponse], error) {
...
func (UnimplementedTokenServiceHandler) Introspect(context.Context, *connect.Request[v1.IntrospectRequest]) (*connect.Response[v1.IntrospectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("anubis.v1.TokenService.Introspect is not implemented"))
}
