...
func (q *Query) cursor(col uint32, r Row) {
	...
	case 8:
		...
		q.nums[q.nn] = int64(r.SignCounter)
		q.nn++
	case 9:
...
var (
	...
	CreatedAt   = TimeCol{1}
	UpdatedAt   = TimeCol{2}
	LastUsedAt  = NullTimeCol{3}
	ExpiresAt   = NullTimeCol{4}
	RevokedAt   = NullTimeCol{5}
...
func (q Query) SignCounterEq(v int64) Query            { return q.Where(SignCounter.Eq(v)) }
func (q Query) SignCounterNotEq(v int64) Query         { return q.Where(SignCounter.NotEq(v)) }
func (q Query) SignCounterGt(v int64) Query            { return q.Where(SignCounter.Gt(v)) }
func (q Query) SignCounterGte(v int64) Query           { return q.Where(SignCounter.Gte(v)) }
func (q Query) SignCounterLt(v int64) Query            { return q.Where(SignCounter.Lt(v)) }
func (q Query) SignCounterLte(v int64) Query           { return q.Where(SignCounter.Lte(v)) }
func (q Query) SignCounterIn(v ...int64) Query         { return q.Where(SignCounter.In(v...)) }
func (q Query) SignCounterNotIn(v ...int64) Query      { return q.Where(SignCounter.NotIn(v...)) }
...
func (q Query) SecretEqLower(v string) Query           { return q.Where(Secret.EqLower(v)) }
...
func (q Query) LookupKeyGte(v string) Query            { return q.Where(LookupKey.Gte(v)) }
func (q Query) LookupKeyLt(v string) Query             { return q.Where(LookupKey.Lt(v)) }
func (q Query) LookupKeyLte(v string) Query            { return q.Where(LookupKey.Lte(v)) }
func (q Query) LookupKeyEqLower(v string) Query        { return q.Where(LookupKey.EqLower(v)) }
func (q Query) LookupKeyLike(v string) Query           { return q.Where(LookupKey.Like(v)) }
func (q Query) LookupKeyILike(v string) Query          { return q.Where(LookupKey.ILike(v)) }
func (q Query) LookupKeyIn(v ...string) Query          { return q.Where(LookupKey.In(v...)) }
func (q Query) LookupKeyNotIn(v ...string) Query       { return q.Where(LookupKey.NotIn(v...)) }
func (q Query) LookupKeyIsNull() Query                 { return q.Where(LookupKey.IsNull()) }
func (q Query) LookupKeyIsNotNull() Query              { return q.Where(LookupKey.IsNotNull()) }
...
func (q Query) LabelIsNull() Query                     { return q.Where(Label.IsNull()) }
func (q Query) LabelIsNotNull() Query                  { return q.Where(Label.IsNotNull()) }
func (q Query) ParamsContains(v runtime.JSON) Query    { return q.Where(Params.Contains(v)) }
func (q Query) ParamsContainedBy(v runtime.JSON) Query { return q.Where(Params.ContainedBy(v)) }
...
var orderTable = [nCols][4]string{
	...
	{ // sign_counter
		"\"sign_counter\"",
		"\"sign_counter\" DESC",
		"\"sign_counter\" ASC NULLS FIRST",
		"\"sign_counter\" DESC NULLS LAST",
	},
	{ // kind
		"\"kind\"",
		"\"kind\" DESC",
	...
	{ // lookup_key
		"\"lookup_key\"",
		"\"lookup_key\" DESC",
		"\"lookup_key\" ASC NULLS FIRST",
		"\"lookup_key\" DESC NULLS LAST",
	},
	{ // label
		"\"label\"",
		"\"label\" DESC",
	...
	{ // params
		"\"params\"",
		"\"params\" DESC",
		"\"params\" ASC NULLS FIRST",
		"\"params\" DESC NULLS LAST",
	},
}
...
var fragTable = [15][28]runtime.Frag{
	...
	{ // sign_counter
		...
		{},
		{},
		{A: "\"sign_counter\" = ANY($", B: ")"},
		{A: "\"sign_counter\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
	...
	{ // lookup_key
		...
		{A: "\"lookup_key\" < $", B: ""},
		{A: "\"lookup_key\" <= $", B: ""},
		{A: "lower(\"lookup_key\") = lower($", B: ")"},
		{A: "\"lookup_key\" LIKE $", B: ""},
		{A: "\"lookup_key\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		...
		{},
		{},
		{A: "\"lookup_key\" IS NULL", B: ""},
		{A: "\"lookup_key\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // label
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	...
	r.LastUsedAt = runtime.Nullable(rv[3], runtime.Timestamptz)
...
const (
	...
	dLastUsedAt  uint64 = 1 << 1
	dExpiresAt   uint64 = 1 << 2
	dRevokedAt   uint64 = 1 << 3
	dIdentityID  uint64 = 1 << 4
	dTenantID    uint64 = 1 << 5
...
const (
	...
	iLastUsedAt  uint64 = 1 << 3
	iExpiresAt   uint64 = 1 << 4
	iRevokedAt   uint64 = 1 << 5
...
func (m *Mut) SetSignCounter(v int64) {
	m.row.SignCounter = v
	m.dirty |= dSignCounter
	m.expr &^= dSignCounter
}

// IncSignCounter adds one to the column's OWN value, in the database.
//
...
func (m *Mut) SetSecret(v string) {
	m.row.Secret = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dSecret
	m.expr &^= dSecret
}

// SetSecretNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetSecretNull() {
	m.row.Secret = runtime.Null[string]{}
	m.dirty |= dSecret
	m.expr &^= dSecret
}
...
// SetLookupKeyNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetLookupKeyNull() {
	m.row.LookupKey = runtime.Null[string]{}
	m.dirty |= dLookupKey
	m.expr &^= dLookupKey
}

func (m *Mut) SetLabel(v string) {
	m.row.Label = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dLabel
	m.expr &^= dLabel
}

// SetLabelNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetLabelNull() {
	m.row.Label = runtime.Null[string]{}
	m.dirty |= dLabel
	m.expr &^= dLabel
}

func (m *Mut) SetParams(v runtime.JSON) {
	m.row.Params = v
	m.dirty |= dParams
	m.expr &^= dParams
}
...
func (n *Ins) SetSignCounter(v int64) {
	n.row.SignCounter = v
	n.set |= iSignCounter
}
...
func (n *Ins) SetSecret(v string) {
	n.row.Secret = runtime.Null[string]{V: v, Valid: true}
	n.set |= iSecret
}

// SetSecretNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetSecretNull() {
	n.row.Secret = runtime.Null[string]{}
	n.set |= iSecret
}
...
// SetLookupKeyNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetLookupKeyNull() {
	n.row.LookupKey = runtime.Null[string]{}
	n.set |= iLookupKey
}

func (n *Ins) SetLabel(v string) {
	n.row.Label = runtime.Null[string]{V: v, Valid: true}
	n.set |= iLabel
}

// SetLabelNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetLabelNull() {
	n.row.Label = runtime.Null[string]{}
	n.set |= iLabel
}

func (n *Ins) SetParams(v runtime.JSON) {
	n.row.Params = v
	n.set |= iParams
}
...
var conflictSpecs = []string{
	" ON CONFLICT (\"id\")",
	" ON CONFLICT (\"lookup_key\") WHERE (lookup_key IS NOT NULL) AND (revoked_at IS NULL)",
	" ON CONFLICT (\"identity_id\") WHERE (kind = 'password'::text) AND (revoked_at IS NULL)",
}
...
// OnConflictLookupKey upserts on the unique index over (lookup_key, where (lookup_key IS NOT NULL) AND (revoked_at IS NULL)).
//
// The row that already exists keeps every column this insert did
// not assign. Follow with DoNothing() to leave it untouched
// entirely.
func (n *Ins) OnConflictLookupKey() *Ins {
	n.conflict = 4
	return n
}

// OnConflictIdentityID upserts on the unique index over (identity_id, where (kind = 'password'::text) AND (revoked_at IS NULL)).
//
// The row that already exists keeps every column this insert did
// not assign. Follow with DoNothing() to leave it untouched
// entirely.
func (n *Ins) OnConflictIdentityID() *Ins {
	n.conflict = 6
	return n
}
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 8:
			args = append(args, n.row.SignCounter)
		case 9:
...
func (s *rowSource) Values() []any {
	...
	s.buf[1] = &r.CreatedAt
	s.buf[2] = &r.UpdatedAt
	s.buf[3] = r.LastUsedAt.Ptr()
	s.buf[4] = r.ExpiresAt.Ptr()
	s.buf[5] = r.RevokedAt.Ptr()
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "credentials", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 6:
			args = append(args, m.row.SignCounter)
		case 7:
