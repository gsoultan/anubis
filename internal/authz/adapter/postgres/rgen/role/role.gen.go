// Code generated by storm v0.2.0. DO NOT EDIT.
// source: table roles
...
func (h BoolCol) Eq(v bool) Pred    { return Pred{col: h.c, op: opEq, num: b2i(v)} }
func (h BoolCol) NotEq(v bool) Pred { return Pred{col: h.c, op: opNotEq, num: b2i(v)} }
...
var upsertTails = []func(uint64) string{
	...
	func(mask uint64) string {
		...
		return onConflictTenantIDName(set)
	},
}
...
func onConflictTenantIDName(set []string) string {
	switch len(set) {
	case 0:
		return " ON CONFLICT (\"tenant_id\", \"name\") DO NOTHING"
	}
	return " ON CONFLICT (\"tenant_id\", \"name\") DO UPDATE SET " + joinAssign(set)
}

// OnConflictTenantIDName upserts on the unique key (tenant_id, name).
