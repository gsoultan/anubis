...
type Row struct {
	...
	TenantID    [16]byte
	FamilyID    [16]byte
	SuccessorID runtime.Null[[16]byte]
	Generation  int32
	Status      string
	TokenHash   []byte
...
func (q *Query) cursor(col uint32, r Row) {
	...
	case 9:
		...
		q.nums[q.nn] = int64(r.Generation)
		q.nn++
	case 10:
...
var (
	CreatedAt   = TimeCol{0}
	ExpiresAt   = TimeCol{1}
	ConsumedAt  = NullTimeCol{2}
	RevokedAt   = NullTimeCol{3}
	ID          = UUIDCol{4}
	SessionID   = UUIDCol{5}
	TenantID    = UUIDCol{6}
	FamilyID    = UUIDCol{7}
	SuccessorID = NullUUIDCol{8}
	Generation  = Int32Col{9}
	Status      = TextCol{10}
...
func (q Query) ConsumedAtEq(v time.Time) Query       { return q.Where(ConsumedAt.Eq(v)) }
func (q Query) ConsumedAtNotEq(v time.Time) Query    { return q.Where(ConsumedAt.NotEq(v)) }
func (q Query) ConsumedAtGt(v time.Time) Query       { return q.Where(ConsumedAt.Gt(v)) }
func (q Query) ConsumedAtGte(v time.Time) Query      { return q.Where(ConsumedAt.Gte(v)) }
func (q Query) ConsumedAtLt(v time.Time) Query       { return q.Where(ConsumedAt.Lt(v)) }
func (q Query) ConsumedAtLte(v time.Time) Query      { return q.Where(ConsumedAt.Lte(v)) }
func (q Query) ConsumedAtIsNull() Query              { return q.Where(ConsumedAt.IsNull()) }
func (q Query) ConsumedAtIsNotNull() Query           { return q.Where(ConsumedAt.IsNotNull()) }
...
func (q Query) FamilyIDEq(v [16]byte) Query          { return q.Where(FamilyID.Eq(v)) }
func (q Query) FamilyIDNotEq(v [16]byte) Query       { return q.Where(FamilyID.NotEq(v)) }
func (q Query) FamilyIDIn(v ...[16]byte) Query       { return q.Where(FamilyID.In(v...)) }
func (q Query) FamilyIDNotIn(v ...[16]byte) Query    { return q.Where(FamilyID.NotIn(v...)) }
func (q Query) SuccessorIDEq(v [16]byte) Query       { return q.Where(SuccessorID.Eq(v)) }
func (q Query) SuccessorIDNotEq(v [16]byte) Query    { return q.Where(SuccessorID.NotEq(v)) }
func (q Query) SuccessorIDIn(v ...[16]byte) Query    { return q.Where(SuccessorID.In(v...)) }
func (q Query) SuccessorIDNotIn(v ...[16]byte) Query { return q.Where(SuccessorID.NotIn(v...)) }
func (q Query) SuccessorIDIsNull() Query             { return q.Where(SuccessorID.IsNull()) }
func (q Query) SuccessorIDIsNotNull() Query          { return q.Where(SuccessorID.IsNotNull()) }
func (q Query) GenerationEq(v int32) Query           { return q.Where(Generation.Eq(v)) }
func (q Query) GenerationNotEq(v int32) Query        { return q.Where(Generation.NotEq(v)) }
func (q Query) GenerationGt(v int32) Query           { return q.Where(Generation.Gt(v)) }
func (q Query) GenerationGte(v int32) Query          { return q.Where(Generation.Gte(v)) }
func (q Query) GenerationLt(v int32) Query           { return q.Where(Generation.Lt(v)) }
func (q Query) GenerationLte(v int32) Query          { return q.Where(Generation.Lte(v)) }
func (q Query) GenerationIn(v ...int32) Query        { return q.Where(Generation.In(v...)) }
func (q Query) GenerationNotIn(v ...int32) Query     { return q.Where(Generation.NotIn(v...)) }
...
func (q Query) TokenHashEq(v []byte) Query           { return q.Where(TokenHash.Eq(v)) }
func (q Query) TokenHashNotEq(v []byte) Query        { return q.Where(TokenHash.NotEq(v)) }
func (q Query) BoundKeyEq(v string) Query            { return q.Where(BoundKey.Eq(v)) }
func (q Query) BoundKeyNotEq(v string) Query         { return q.Where(BoundKey.NotEq(v)) }
func (q Query) BoundKeyGt(v string) Query            { return q.Where(BoundKey.Gt(v)) }
func (q Query) BoundKeyGte(v string) Query           { return q.Where(BoundKey.Gte(v)) }
func (q Query) BoundKeyLt(v string) Query            { return q.Where(BoundKey.Lt(v)) }
func (q Query) BoundKeyLte(v string) Query           { return q.Where(BoundKey.Lte(v)) }
func (q Query) BoundKeyEqLower(v string) Query       { return q.Where(BoundKey.EqLower(v)) }
func (q Query) BoundKeyLike(v string) Query          { return q.Where(BoundKey.Like(v)) }
func (q Query) BoundKeyILike(v string) Query         { return q.Where(BoundKey.ILike(v)) }
func (q Query) BoundKeyIn(v ...string) Query         { return q.Where(BoundKey.In(v...)) }
...
var orderTable = [nCols][4]string{
	...
	{ // family_id
		"\"family_id\"",
		"\"family_id\" DESC",
		"\"family_id\" ASC NULLS FIRST",
		"\"family_id\" DESC NULLS LAST",
	},
	{ // successor_id
		"\"successor_id\"",
		"\"successor_id\" DESC",
		"\"successor_id\" ASC NULLS FIRST",
		"\"successor_id\" DESC NULLS LAST",
	},
	{ // generation
		"\"generation\"",
		"\"generation\" DESC",
		"\"generation\" ASC NULLS FIRST",
		"\"generation\" DESC NULLS LAST",
	},
	{ // status
		"\"status\"",
		"\"status\" DESC",
	...
	{ // token_hash
		"\"token_hash\"",
		"\"token_hash\" DESC",
		"\"token_hash\" ASC NULLS FIRST",
		"\"token_hash\" DESC NULLS LAST",
	},
	{ // bound_key
		"\"bound_key\"",
		"\"bound_key\" DESC",
...
var fragTable = [13][28]runtime.Frag{
	...
	{ // consumed_at
		...
		{},
		{},
		{A: "\"consumed_at\" IS NULL", B: ""},
		{A: "\"consumed_at\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // revoked_at
	...
	{ // successor_id
		...
		{},
		{},
		{A: "\"successor_id\" = ANY($", B: ")"},
		{A: "\"successor_id\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
		...
		{},
		{},
		{A: "\"successor_id\" IS NULL", B: ""},
		{A: "\"successor_id\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // generation
	...
	{ // bound_key
		...
		{},
		{},
		{A: "\"bound_key\" IS NULL", B: ""},
		{A: "\"bound_key\" IS NOT NULL", B: ""},
		{},
		{},
	},
}
...
var defaultOrder = [2]runtime.Tok{
	runtime.MakeOrder(runtime.Asc, 4), // id
	runtime.MakeOrder(runtime.Asc, 1), // expires_at
}
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	...
	r.ConsumedAt = runtime.Nullable(rv[2], runtime.Timestamptz)
	r.RevokedAt = runtime.Nullable(rv[3], runtime.Timestamptz)
	copy(r.ID[:], rv[4])
	copy(r.SessionID[:], rv[5])
	copy(r.TenantID[:], rv[6])
	copy(r.FamilyID[:], rv[7])
	r.SuccessorID = runtime.Nullable(rv[8], runtime.UUID)
	r.Generation = runtime.Int4(rv[9])
...
func (q Query) bindPreds(b *binder) []any {
	v := b.vals[:0]
	var ns, nn, nr, ntm, nby, nar, nas, nai32 uint8
...
const (
	...
	dConsumedAt  uint64 = 1 << 1
	dRevokedAt   uint64 = 1 << 2
	dSessionID   uint64 = 1 << 3
	dTenantID    uint64 = 1 << 4
	dFamilyID    uint64 = 1 << 5
	dSuccessorID uint64 = 1 << 6
	dGeneration  uint64 = 1 << 7
	dStatus      uint64 = 1 << 8
...
var exprFrags = [nUpdatable]runtime.Frag{
	...
	{A: "\"consumed_at\" = now()", B: ""}, // consumed_at = the database's clock
	{A: "\"revoked_at\" = now()", B: ""},  // revoked_at = the database's clock
	{},                                    // session_id has no server-side form
	{},                                    // tenant_id has no server-side form
	{},                                    // family_id has no server-side form
	{},                                    // successor_id has no server-side form
	{A: "\"generation\" = \"generation\" + 1", B: ""}, // generation = its own value plus one
...
const (
	...
	iExpiresAt   uint64 = 1 << 1
	iConsumedAt  uint64 = 1 << 2
	iRevokedAt   uint64 = 1 << 3
	iID          uint64 = 1 << 4
	iSessionID   uint64 = 1 << 5
	iTenantID    uint64 = 1 << 6
	iFamilyID    uint64 = 1 << 7
	iSuccessorID uint64 = 1 << 8
	iGeneration  uint64 = 1 << 9
	iStatus      uint64 = 1 << 10
...
func MutateKey(iD [16]byte, expiresAt time.Time) Mut {
	return Mut{row: Row{
		ID:        iD,
		ExpiresAt: expiresAt,
	}}
...
func (m *Mut) SetConsumedAt(v time.Time) {
	m.row.ConsumedAt = runtime.Null[time.Time]{V: v, Valid: true}
	m.dirty |= dConsumedAt
	m.expr &^= dConsumedAt
}

// SetConsumedAtNow assigns the database's clock, not this process's.
//
// Binding time.Now() instead would record when THIS server
// thought it was. Servers skew, so rows written seconds apart
// can land out of order, and an event stamped by a fast clock
// reads as preceding the thing that caused it.
func (m *Mut) SetConsumedAtNow() {
	m.expr |= dConsumedAt
	m.dirty &^= dConsumedAt
}

// SetConsumedAtNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetConsumedAtNull() {
	m.row.ConsumedAt = runtime.Null[time.Time]{}
	m.dirty |= dConsumedAt
	m.expr &^= dConsumedAt
}
...
func (m *Mut) SetFamilyID(v [16]byte) {
	m.row.FamilyID = v
	m.dirty |= dFamilyID
	m.expr &^= dFamilyID
}

func (m *Mut) SetSuccessorID(v [16]byte) {
	m.row.SuccessorID = runtime.Null[[16]byte]{V: v, Valid: true}
	m.dirty |= dSuccessorID
	m.expr &^= dSuccessorID
}

// SetSuccessorIDNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetSuccessorIDNull() {
	m.row.SuccessorID = runtime.Null[[16]byte]{}
	m.dirty |= dSuccessorID
	m.expr &^= dSuccessorID
}

func (m *Mut) SetGeneration(v int32) {
	m.row.Generation = v
	m.dirty |= dGeneration
	m.expr &^= dGeneration
}

// IncGeneration adds one to the column's OWN value, in the database.
//
...
func (m *Mut) SetTokenHash(v []byte) {
	m.row.TokenHash = v
	m.dirty |= dTokenHash
	m.expr &^= dTokenHash
}

func (m *Mut) SetBoundKey(v string) {
	m.row.BoundKey = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dBoundKey
	m.expr &^= dBoundKey
}

// SetBoundKeyNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetBoundKeyNull() {
	m.row.BoundKey = runtime.Null[string]{}
	m.dirty |= dBoundKey
	m.expr &^= dBoundKey
}
...
func (n *Ins) SetConsumedAt(v time.Time) {
	n.row.ConsumedAt = runtime.Null[time.Time]{V: v, Valid: true}
	n.set |= iConsumedAt
}

// SetConsumedAtNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetConsumedAtNull() {
	n.row.ConsumedAt = runtime.Null[time.Time]{}
	n.set |= iConsumedAt
}
...
func (n *Ins) SetFamilyID(v [16]byte) {
	n.row.FamilyID = v
	n.set |= iFamilyID
}

func (n *Ins) SetSuccessorID(v [16]byte) {
	n.row.SuccessorID = runtime.Null[[16]byte]{V: v, Valid: true}
	n.set |= iSuccessorID
}

// SetSuccessorIDNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetSuccessorIDNull() {
	n.row.SuccessorID = runtime.Null[[16]byte]{}
	n.set |= iSuccessorID
}

func (n *Ins) SetGeneration(v int32) {
	n.row.Generation = v
	n.set |= iGeneration
}
...
func (n *Ins) SetTokenHash(v []byte) {
	n.row.TokenHash = v
	n.set |= iTokenHash
}

func (n *Ins) SetBoundKey(v string) {
	n.row.BoundKey = runtime.Null[string]{V: v, Valid: true}
	n.set |= iBoundKey
}

// SetBoundKeyNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetBoundKeyNull() {
	n.row.BoundKey = runtime.Null[string]{}
	n.set |= iBoundKey
}
...
var conflictSpecs = []string{
	" ON CONFLICT (\"id\", \"expires_at\")",
	" ON CONFLICT (\"token_hash\", \"expires_at\")",
}
...
func assignable(i uint8, mask uint64) []string {
	...
	case 0:
		...
		if mask&(1<<7) != 0 {
			set = append(set, "family_id")
		}
		if mask&(1<<8) != 0 {
			set = append(set, "successor_id")
		}
		if mask&(1<<9) != 0 {
			set = append(set, "generation")
		}
		if mask&(1<<10) != 0 {
			set = append(set, "status")
		}
		if mask&(1<<11) != 0 {
			set = append(set, "token_hash")
		}
		if mask&(1<<12) != 0 {
...
// OnConflictIDExpiresAt upserts on the unique index over (id, expires_at).
//
// The row that already exists keeps every column this insert did
// not assign. Follow with DoNothing() to leave it untouched
// entirely.
func (n *Ins) OnConflictIDExpiresAt() *Ins {
	n.conflict = 2
	return n
}

// OnConflictTokenHashExpiresAt upserts on the unique index over (token_hash, expires_at).
//
// The row that already exists keeps every column this insert did
// not assign. Follow with DoNothing() to leave it untouched
// entirely.
func (n *Ins) OnConflictTokenHashExpiresAt() *Ins {
	n.conflict = 4
	return n
}
...
//	n.OnConflictIDExpiresAt().DoNothing()  // only on that one index
//
...
var assignFor = map[string]string{
	...
	"consumed_at":  "\"consumed_at\" = EXCLUDED.\"consumed_at\"",
	"revoked_at":   "\"revoked_at\" = EXCLUDED.\"revoked_at\"",
	"session_id":   "\"session_id\" = EXCLUDED.\"session_id\"",
	"tenant_id":    "\"tenant_id\" = EXCLUDED.\"tenant_id\"",
	"family_id":    "\"family_id\" = EXCLUDED.\"family_id\"",
	"successor_id": "\"successor_id\" = EXCLUDED.\"successor_id\"",
	"generation":   "\"generation\" = EXCLUDED.\"generation\"",
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 2:
			args = append(args, n.row.ConsumedAt.Arg())
		case 3:
			args = append(args, n.row.RevokedAt.Arg())
		case 4:
			args = append(args, n.row.ID)
		case 5:
			args = append(args, n.row.SessionID)
		case 6:
			args = append(args, n.row.TenantID)
		case 7:
			args = append(args, n.row.FamilyID)
		case 8:
			args = append(args, n.row.SuccessorID.Arg())
		case 9:
			args = append(args, n.row.Generation)
		case 10:
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.FamilyID)
	args = append(args, r.SuccessorID.Arg())
...
func (s *rowSource) Values() []any {
	...
	s.buf[0] = &r.CreatedAt
	s.buf[1] = &r.ExpiresAt
	s.buf[2] = r.ConsumedAt.Ptr()
	s.buf[3] = r.RevokedAt.Ptr()
	s.buf[4] = &r.ID
	s.buf[5] = &r.SessionID
	s.buf[6] = &r.TenantID
	s.buf[7] = &r.FamilyID
	s.buf[8] = r.SuccessorID.Ptr()
	s.buf[9] = &r.Generation
	s.buf[10] = &r.Status
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "refresh_tokens", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 1:
			args = append(args, m.row.ConsumedAt.Arg())
		case 2:
			args = append(args, m.row.RevokedAt.Arg())
		case 3:
			args = append(args, m.row.SessionID)
		case 4:
			args = append(args, m.row.TenantID)
		case 5:
			args = append(args, m.row.FamilyID)
		case 6:
			args = append(args, m.row.SuccessorID.Arg())
		case 7:
			args = append(args, m.row.Generation)
		case 8:
...
func DeleteOp(iD [16]byte, expiresAt time.Time) runtime.BatchOp {
	return runtime.BatchOp{SQL: deleteSQL, Args: []any{iD, expiresAt}}
}
...
func Delete(ctx context.Context, ex runtime.Executor, iD [16]byte, expiresAt time.Time) error {
	n, err := ex.Exec(ctx, deleteSQL, []any{iD, expiresAt})
	if err != nil {
		return err
	}
	if n == 0 {
