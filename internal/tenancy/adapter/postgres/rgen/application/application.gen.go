...
type Row struct {
	...
	CreatedAt              time.Time
	UpdatedAt              time.Time
	AccessTokenTtl         runtime.Interval
	RefreshTokenTtl        runtime.Interval
	TenantID               [16]byte
...
func (q *Query) cursor(col uint32, r Row) {
	...
	case 6:
		...
		q.nums[q.nn] = int64(r.ManifestVersion)
		q.nn++
	case 7:
	...
	case 11:
		...
		q.strs[q.ns] = r.ClientSecretHash.V
		q.ns++
	case 13:
		if int(q.ns) >= len(q.strs) {
			q.over = true
		...
		q.strs[q.ns] = r.BackchannelLogoutURI.V
		q.ns++
	case 14:
		if int(q.ns) >= len(q.strs) {
			q.over = true
...
var (
	...
	CreatedAt              = TimeCol{1}
	UpdatedAt              = TimeCol{2}
	AccessTokenTtl         = IntervalCol{3}
	RefreshTokenTtl        = IntervalCol{4}
	TenantID               = UUIDCol{5}
	ManifestVersion        = Int32Col{6}
	Kind                   = TextCol{7}
	Status                 = TextCol{8}
	Slug                   = TextCol{9}
	Name                   = TextCol{10}
	ClientSecretHash       = NullTextCol{11}
	RedirectUris           = TextArrayCol{12}
...
// IntervalCol addresses a interval column.
type IntervalCol struct{ c uint8 }

func (h IntervalCol) Asc() Sort  { return Sort(runtime.MakeOrder(runtime.Asc, uint32(h.c))) }
func (h IntervalCol) Desc() Sort { return Sort(runtime.MakeOrder(runtime.Desc, uint32(h.c))) }
func (h IntervalCol) AscNullsFirst() Sort {
	return Sort(runtime.MakeOrder(runtime.AscNullsFirst, uint32(h.c)))
}
func (h IntervalCol) DescNullsLast() Sort {
	return Sort(runtime.MakeOrder(runtime.DescNullsLast, uint32(h.c)))
}
...
func (q Query) ManifestVersionEq(v int32) Query         { return q.Where(ManifestVersion.Eq(v)) }
func (q Query) ManifestVersionNotEq(v int32) Query      { return q.Where(ManifestVersion.NotEq(v)) }
func (q Query) ManifestVersionGt(v int32) Query         { return q.Where(ManifestVersion.Gt(v)) }
func (q Query) ManifestVersionGte(v int32) Query        { return q.Where(ManifestVersion.Gte(v)) }
func (q Query) ManifestVersionLt(v int32) Query         { return q.Where(ManifestVersion.Lt(v)) }
func (q Query) ManifestVersionLte(v int32) Query        { return q.Where(ManifestVersion.Lte(v)) }
func (q Query) ManifestVersionIn(v ...int32) Query      { return q.Where(ManifestVersion.In(v...)) }
func (q Query) ManifestVersionNotIn(v ...int32) Query   { return q.Where(ManifestVersion.NotIn(v...)) }
...
func (q Query) KindEqLower(v string) Query              { return q.Where(Kind.EqLower(v)) }
...
func (q Query) SlugEq(v string) Query                   { return q.Where(Slug.Eq(v)) }
func (q Query) SlugNotEq(v string) Query                { return q.Where(Slug.NotEq(v)) }
func (q Query) SlugGt(v string) Query                   { return q.Where(Slug.Gt(v)) }
func (q Query) SlugGte(v string) Query                  { return q.Where(Slug.Gte(v)) }
func (q Query) SlugLt(v string) Query                   { return q.Where(Slug.Lt(v)) }
func (q Query) SlugLte(v string) Query                  { return q.Where(Slug.Lte(v)) }
func (q Query) SlugEqLower(v string) Query              { return q.Where(Slug.EqLower(v)) }
func (q Query) SlugLike(v string) Query                 { return q.Where(Slug.Like(v)) }
func (q Query) SlugILike(v string) Query                { return q.Where(Slug.ILike(v)) }
func (q Query) SlugIn(v ...string) Query                { return q.Where(Slug.In(v...)) }
func (q Query) SlugNotIn(v ...string) Query             { return q.Where(Slug.NotIn(v...)) }
...
func (q Query) ClientSecretHashEq(v string) Query       { return q.Where(ClientSecretHash.Eq(v)) }
func (q Query) ClientSecretHashNotEq(v string) Query    { return q.Where(ClientSecretHash.NotEq(v)) }
func (q Query) ClientSecretHashGt(v string) Query       { return q.Where(ClientSecretHash.Gt(v)) }
func (q Query) ClientSecretHashGte(v string) Query      { return q.Where(ClientSecretHash.Gte(v)) }
func (q Query) ClientSecretHashLt(v string) Query       { return q.Where(ClientSecretHash.Lt(v)) }
func (q Query) ClientSecretHashLte(v string) Query      { return q.Where(ClientSecretHash.Lte(v)) }
func (q Query) ClientSecretHashEqLower(v string) Query  { return q.Where(ClientSecretHash.EqLower(v)) }
func (q Query) ClientSecretHashLike(v string) Query     { return q.Where(ClientSecretHash.Like(v)) }
func (q Query) ClientSecretHashILike(v string) Query    { return q.Where(ClientSecretHash.ILike(v)) }
func (q Query) ClientSecretHashIn(v ...string) Query    { return q.Where(ClientSecretHash.In(v...)) }
func (q Query) ClientSecretHashNotIn(v ...string) Query { return q.Where(ClientSecretHash.NotIn(v...)) }
func (q Query) ClientSecretHashIsNull() Query           { return q.Where(ClientSecretHash.IsNull()) }
func (q Query) ClientSecretHashIsNotNull() Query        { return q.Where(ClientSecretHash.IsNotNull()) }
func (q Query) RedirectUrisContains(v ...string) Query  { return q.Where(RedirectUris.Contains(v...)) }
func (q Query) RedirectUrisContainedBy(v ...string) Query {
	return q.Where(RedirectUris.ContainedBy(v...))
}
func (q Query) RedirectUrisOverlaps(v ...string) Query { return q.Where(RedirectUris.Overlaps(v...)) }
func (q Query) BackchannelLogoutURIEq(v string) Query  { return q.Where(BackchannelLogoutURI.Eq(v)) }
func (q Query) BackchannelLogoutURINotEq(v string) Query {
	return q.Where(BackchannelLogoutURI.NotEq(v))
}
func (q Query) BackchannelLogoutURIGt(v string) Query  { return q.Where(BackchannelLogoutURI.Gt(v)) }
func (q Query) BackchannelLogoutURIGte(v string) Query { return q.Where(BackchannelLogoutURI.Gte(v)) }
func (q Query) BackchannelLogoutURILt(v string) Query  { return q.Where(BackchannelLogoutURI.Lt(v)) }
func (q Query) BackchannelLogoutURILte(v string) Query { return q.Where(BackchannelLogoutURI.Lte(v)) }
func (q Query) BackchannelLogoutURIEqLower(v string) Query {
	return q.Where(BackchannelLogoutURI.EqLower(v))
}
func (q Query) BackchannelLogoutURILike(v string) Query { return q.Where(BackchannelLogoutURI.Like(v)) }
func (q Query) BackchannelLogoutURIILike(v string) Query {
	return q.Where(BackchannelLogoutURI.ILike(v))
}
func (q Query) BackchannelLogoutURIIn(v ...string) Query {
	return q.Where(BackchannelLogoutURI.In(v...))
}
func (q Query) BackchannelLogoutURINotIn(v ...string) Query {
	return q.Where(BackchannelLogoutURI.NotIn(v...))
}
func (q Query) BackchannelLogoutURIIsNull() Query { return q.Where(BackchannelLogoutURI.IsNull()) }
func (q Query) BackchannelLogoutURIIsNotNull() Query {
	return q.Where(BackchannelLogoutURI.IsNotNull())
}
func (q Query) TokenFormatEq(v string) Query       { return q.Where(TokenFormat.Eq(v)) }
func (q Query) TokenFormatNotEq(v string) Query    { return q.Where(TokenFormat.NotEq(v)) }
func (q Query) TokenFormatGt(v string) Query       { return q.Where(TokenFormat.Gt(v)) }
func (q Query) TokenFormatGte(v string) Query      { return q.Where(TokenFormat.Gte(v)) }
func (q Query) TokenFormatLt(v string) Query       { return q.Where(TokenFormat.Lt(v)) }
func (q Query) TokenFormatLte(v string) Query      { return q.Where(TokenFormat.Lte(v)) }
func (q Query) TokenFormatEqLower(v string) Query  { return q.Where(TokenFormat.EqLower(v)) }
func (q Query) TokenFormatLike(v string) Query     { return q.Where(TokenFormat.Like(v)) }
func (q Query) TokenFormatILike(v string) Query    { return q.Where(TokenFormat.ILike(v)) }
func (q Query) TokenFormatIn(v ...string) Query    { return q.Where(TokenFormat.In(v...)) }
func (q Query) TokenFormatNotIn(v ...string) Query { return q.Where(TokenFormat.NotIn(v...)) }
func (q Query) PostLogoutRedirectUrisContains(v ...string) Query {
	return q.Where(PostLogoutRedirectUris.Contains(v...))
}
func (q Query) PostLogoutRedirectUrisContainedBy(v ...string) Query {
	return q.Where(PostLogoutRedirectUris.ContainedBy(v...))
}
...
var orderTable = [nCols][4]string{
	...
	{ // access_token_ttl
		"\"access_token_ttl\"",
		"\"access_token_ttl\" DESC",
		"\"access_token_ttl\" ASC NULLS FIRST",
		"\"access_token_ttl\" DESC NULLS LAST",
	},
	{ // refresh_token_ttl
		"\"refresh_token_ttl\"",
		"\"refresh_token_ttl\" DESC",
		"\"refresh_token_ttl\" ASC NULLS FIRST",
		"\"refresh_token_ttl\" DESC NULLS LAST",
	},
	{ // tenant_id
		"\"tenant_id\"",
		"\"tenant_id\" DESC",
	...
	{ // manifest_version
		...
		"\"manifest_version\" ASC NULLS FIRST",
		"\"manifest_version\" DESC NULLS LAST",
	},
	{ // kind
		"\"kind\"",
		"\"kind\" DESC",
	...
	{ // slug
		"\"slug\"",
		"\"slug\" DESC",
		"\"slug\" ASC NULLS FIRST",
		"\"slug\" DESC NULLS LAST",
	},
	{ // name
		"\"name\"",
		"\"name\" DESC",
	...
	{ // client_secret_hash
		"\"client_secret_hash\"",
		"\"client_secret_hash\" DESC",
		"\"client_secret_hash\" ASC NULLS FIRST",
		"\"client_secret_hash\" DESC NULLS LAST",
	},
	{ // redirect_uris
		"\"redirect_uris\"",
		"\"redirect_uris\" DESC",
		"\"redirect_uris\" ASC NULLS FIRST",
		"\"redirect_uris\" DESC NULLS LAST",
	},
	{ // backchannel_logout_uri
		"\"backchannel_logout_uri\"",
		"\"backchannel_logout_uri\" DESC",
		"\"backchannel_logout_uri\" ASC NULLS FIRST",
		"\"backchannel_logout_uri\" DESC NULLS LAST",
	},
	{ // token_format
		"\"token_format\"",
		"\"token_format\" DESC",
		"\"token_format\" ASC NULLS FIRST",
		"\"token_format\" DESC NULLS LAST",
	},
	{ // post_logout_redirect_uris
		"\"post_logout_redirect_uris\"",
		"\"post_logout_redirect_uris\" DESC",
...
var fragTable = [16][28]runtime.Frag{
	...
	{ // manifest_version
		...
		{},
		{},
		{A: "\"manifest_version\" = ANY($", B: ")"},
		{A: "\"manifest_version\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
	...
	{ // client_secret_hash
		{}, // opNone
		{A: "\"client_secret_hash\" = $", B: ""},
		{A: "\"client_secret_hash\" <> $", B: ""},
		{A: "\"client_secret_hash\" > $", B: ""},
		{A: "\"client_secret_hash\" >= $", B: ""},
		{A: "\"client_secret_hash\" < $", B: ""},
		{A: "\"client_secret_hash\" <= $", B: ""},
		{A: "lower(\"client_secret_hash\") = lower($", B: ")"},
		{A: "\"client_secret_hash\" LIKE $", B: ""},
		{A: "\"client_secret_hash\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"client_secret_hash\" = ANY($", B: ")"},
		{A: "\"client_secret_hash\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
		...
		{},
		{},
		{A: "\"client_secret_hash\" IS NULL", B: ""},
		{A: "\"client_secret_hash\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // redirect_uris
	...
	{ // backchannel_logout_uri
		{}, // opNone
		{A: "\"backchannel_logout_uri\" = $", B: ""},
		{A: "\"backchannel_logout_uri\" <> $", B: ""},
		{A: "\"backchannel_logout_uri\" > $", B: ""},
		{A: "\"backchannel_logout_uri\" >= $", B: ""},
		{A: "\"backchannel_logout_uri\" < $", B: ""},
		{A: "\"backchannel_logout_uri\" <= $", B: ""},
		{A: "lower(\"backchannel_logout_uri\") = lower($", B: ")"},
		{A: "\"backchannel_logout_uri\" LIKE $", B: ""},
		{A: "\"backchannel_logout_uri\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"backchannel_logout_uri\" = ANY($", B: ")"},
		{A: "\"backchannel_logout_uri\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
		...
		{},
		{},
		{A: "\"backchannel_logout_uri\" IS NULL", B: ""},
		{A: "\"backchannel_logout_uri\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // token_format
		...
		{A: "\"token_format\" < $", B: ""},
		{A: "\"token_format\" <= $", B: ""},
		{A: "lower(\"token_format\") = lower($", B: ")"},
		{A: "\"token_format\" LIKE $", B: ""},
		{A: "\"token_format\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"token_format\" = ANY($", B: ")"},
		{A: "\"token_format\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	...
	r.AccessTokenTtl, decErr = runtime.IntervalErr(rv[3])
	if decErr != nil {
		return decErr
	}
	r.RefreshTokenTtl, decErr = runtime.IntervalErr(rv[4])
	if decErr != nil {
		return decErr
	}
	copy(r.TenantID[:], rv[5])
	r.ManifestVersion = runtime.Int4(rv[6])
	r.Kind = sl.Str(rv[7])
	r.Status = sl.Str(rv[8])
	r.Slug = sl.Str(rv[9])
	r.Name = sl.Str(rv[10])
	r.ClientSecretHash = runtime.NullText(rv[11], sl)
	r.RedirectUris, decErr = runtime.TextArray(rv[12], sl)
	if decErr != nil {
		return decErr
	}
	r.BackchannelLogoutURI = runtime.NullText(rv[13], sl)
	r.TokenFormat = sl.Str(rv[14])
	r.PostLogoutRedirectUris, decErr = runtime.TextArray(rv[15], sl)
	if decErr != nil {
		return decErr
	}
	return decErr
...
const (
	...
	dAccessTokenTtl         uint64 = 1 << 1
	dRefreshTokenTtl        uint64 = 1 << 2
	dTenantID               uint64 = 1 << 3
	dManifestVersion        uint64 = 1 << 4
	dKind                   uint64 = 1 << 5
	dStatus                 uint64 = 1 << 6
	dSlug                   uint64 = 1 << 7
	dName                   uint64 = 1 << 8
	dClientSecretHash       uint64 = 1 << 9
	dRedirectUris           uint64 = 1 << 10
...
var setFrags = [nUpdatable]runtime.Frag{
	...
	{A: "\"access_token_ttl\" = $", B: ""},          // access_token_ttl
	{A: "\"refresh_token_ttl\" = $", B: ""},         // refresh_token_ttl
	{A: "\"tenant_id\" = $", B: ""},                 // tenant_id
	{A: "\"manifest_version\" = $", B: ""},          // manifest_version
	{A: "\"kind\" = $", B: ""},                      // kind
	{A: "\"status\" = $", B: ""},                    // status
	{A: "\"slug\" = $", B: ""},                      // slug
	{A: "\"name\" = $", B: ""},                      // name
	{A: "\"client_secret_hash\" = $", B: ""},        // client_secret_hash
	{A: "\"redirect_uris\" = $", B: ""},             // redirect_uris
...
var exprFrags = [nUpdatable]runtime.Frag{
	...
	{},                                   // access_token_ttl has no server-side form
	{},                                   // refresh_token_ttl has no server-side form
	{},                                   // tenant_id has no server-side form
	{A: "\"manifest_version\" = \"manifest_version\" + 1", B: ""}, // manifest_version = its own value plus one
	{}, // kind has no server-side form
	{}, // status has no server-side form
	{}, // slug has no server-side form
	{}, // name has no server-side form
	{}, // client_secret_hash has no server-side form
	{}, // redirect_uris has no server-side form
...
const (
	...
	iAccessTokenTtl         uint64 = 1 << 3
	iRefreshTokenTtl        uint64 = 1 << 4
	iTenantID               uint64 = 1 << 5
	iManifestVersion        uint64 = 1 << 6
	iKind                   uint64 = 1 << 7
	iStatus                 uint64 = 1 << 8
	iSlug                   uint64 = 1 << 9
	iName                   uint64 = 1 << 10
	iClientSecretHash       uint64 = 1 << 11
	iRedirectUris           uint64 = 1 << 12
...
func (m *Mut) SetAccessTokenTtl(v runtime.Interval) {
	m.row.AccessTokenTtl = v
	m.dirty |= dAccessTokenTtl
	m.expr &^= dAccessTokenTtl
}

func (m *Mut) SetRefreshTokenTtl(v runtime.Interval) {
	m.row.RefreshTokenTtl = v
	m.dirty |= dRefreshTokenTtl
	m.expr &^= dRefreshTokenTtl
}
...
func (m *Mut) SetManifestVersion(v int32) {
	m.row.ManifestVersion = v
	m.dirty |= dManifestVersion
	m.expr &^= dManifestVersion
}

// IncManifestVersion adds one to the column's OWN value, in the database.
//
...
func (m *Mut) SetClientSecretHash(v string) {
	m.row.ClientSecretHash = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dClientSecretHash
	m.expr &^= dClientSecretHash
}

// SetClientSecretHashNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetClientSecretHashNull() {
	m.row.ClientSecretHash = runtime.Null[string]{}
	m.dirty |= dClientSecretHash
	m.expr &^= dClientSecretHash
}

func (m *Mut) SetRedirectUris(v []string) {
	m.row.RedirectUris = v
	m.dirty |= dRedirectUris
	m.expr &^= dRedirectUris
}

func (m *Mut) SetBackchannelLogoutURI(v string) {
	m.row.BackchannelLogoutURI = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dBackchannelLogoutURI
	m.expr &^= dBackchannelLogoutURI
}

// SetBackchannelLogoutURINull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetBackchannelLogoutURINull() {
	m.row.BackchannelLogoutURI = runtime.Null[string]{}
	m.dirty |= dBackchannelLogoutURI
	m.expr &^= dBackchannelLogoutURI
}

func (m *Mut) SetTokenFormat(v string) {
	m.row.TokenFormat = v
	m.dirty |= dTokenFormat
	m.expr &^= dTokenFormat
}

func (m *Mut) SetPostLogoutRedirectUris(v []string) {
	m.row.PostLogoutRedirectUris = v
	m.dirty |= dPostLogoutRedirectUris
...
func (n *Ins) SetAccessTokenTtl(v runtime.Interval) {
	n.row.AccessTokenTtl = v
	n.set |= iAccessTokenTtl
}

func (n *Ins) SetRefreshTokenTtl(v runtime.Interval) {
	n.row.RefreshTokenTtl = v
	n.set |= iRefreshTokenTtl
}
...
func (n *Ins) SetManifestVersion(v int32) {
	n.row.ManifestVersion = v
	n.set |= iManifestVersion
}
...
func (n *Ins) SetClientSecretHash(v string) {
	n.row.ClientSecretHash = runtime.Null[string]{V: v, Valid: true}
	n.set |= iClientSecretHash
}

// SetClientSecretHashNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetClientSecretHashNull() {
	n.row.ClientSecretHash = runtime.Null[string]{}
	n.set |= iClientSecretHash
}

func (n *Ins) SetRedirectUris(v []string) {
	n.row.RedirectUris = v
	n.set |= iRedirectUris
}

func (n *Ins) SetBackchannelLogoutURI(v string) {
	n.row.BackchannelLogoutURI = runtime.Null[string]{V: v, Valid: true}
	n.set |= iBackchannelLogoutURI
}

// SetBackchannelLogoutURINull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetBackchannelLogoutURINull() {
	n.row.BackchannelLogoutURI = runtime.Null[string]{}
	n.set |= iBackchannelLogoutURI
}

func (n *Ins) SetTokenFormat(v string) {
	n.row.TokenFormat = v
	n.set |= iTokenFormat
}

func (n *Ins) SetPostLogoutRedirectUris(v []string) {
	n.row.PostLogoutRedirectUris = v
...
func assignable(i uint8, mask uint64) []string {
	...
	case 0:
		...
		if mask&(1<<3) != 0 {
			set = append(set, "access_token_ttl")
		}
		if mask&(1<<4) != 0 {
			set = append(set, "refresh_token_ttl")
		}
		if mask&(1<<5) != 0 {
			set = append(set, "tenant_id")
		}
		if mask&(1<<6) != 0 {
			set = append(set, "manifest_version")
		}
		if mask&(1<<7) != 0 {
			set = append(set, "kind")
		}
		...
		if mask&(1<<11) != 0 {
			set = append(set, "client_secret_hash")
		}
		if mask&(1<<12) != 0 {
			set = append(set, "redirect_uris")
		}
		if mask&(1<<13) != 0 {
			set = append(set, "backchannel_logout_uri")
		}
		if mask&(1<<14) != 0 {
			set = append(set, "token_format")
		}
		if mask&(1<<15) != 0 {
...
// OnConflictIDSlug upserts on the unique index over (id, slug).
//
// The row that already exists keeps every column this insert did
// not assign. Follow with DoNothing() to leave it untouched
// entirely.
func (n *Ins) OnConflictIDSlug() *Ins {
	n.conflict = 4
	return n
}
...
// OnConflictTenantIDSlug upserts on the unique index over (tenant_id, slug).
//
// The row that already exists keeps every column this insert did
// not assign. Follow with DoNothing() to leave it untouched
// entirely.
func (n *Ins) OnConflictTenantIDSlug() *Ins {
	n.conflict = 8
	return n
}
...
var assignFor = map[string]string{
	...
	"access_token_ttl":          "\"access_token_ttl\" = EXCLUDED.\"access_token_ttl\"",
	"refresh_token_ttl":         "\"refresh_token_ttl\" = EXCLUDED.\"refresh_token_ttl\"",
	"tenant_id":                 "\"tenant_id\" = EXCLUDED.\"tenant_id\"",
	"manifest_version":          "\"manifest_version\" = EXCLUDED.\"manifest_version\"",
	"kind":                      "\"kind\" = EXCLUDED.\"kind\"",
	"status":                    "\"status\" = EXCLUDED.\"status\"",
	"slug":                      "\"slug\" = EXCLUDED.\"slug\"",
	"name":                      "\"name\" = EXCLUDED.\"name\"",
	"client_secret_hash":        "\"client_secret_hash\" = EXCLUDED.\"client_secret_hash\"",
	"redirect_uris":             "\"redirect_uris\" = EXCLUDED.\"redirect_uris\"",
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 3:
			args = append(args, n.row.AccessTokenTtl)
		case 4:
			args = append(args, n.row.RefreshTokenTtl)
		case 5:
			args = append(args, n.row.TenantID)
		case 6:
			args = append(args, n.row.ManifestVersion)
		case 7:
			args = append(args, n.row.Kind)
		case 8:
			args = append(args, n.row.Status)
		case 9:
			args = append(args, n.row.Slug)
		case 10:
			args = append(args, n.row.Name)
		case 11:
			args = append(args, n.row.ClientSecretHash.Arg())
		case 12:
			args = append(args, n.row.RedirectUris)
		case 13:
			args = append(args, n.row.BackchannelLogoutURI.Arg())
		case 14:
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.AccessTokenTtl)
	args = append(args, r.RefreshTokenTtl)
	args = append(args, r.TenantID)
	args = append(args, r.ManifestVersion)
	args = append(args, r.Kind)
	args = append(args, r.Status)
	args = append(args, r.Slug)
	args = append(args, r.Name)
	args = append(args, r.ClientSecretHash.Arg())
	args = append(args, r.RedirectUris)
...
func (s *rowSource) Values() []any {
	...
	s.buf[1] = &r.CreatedAt
	s.buf[2] = &r.UpdatedAt
	s.buf[3] = &r.AccessTokenTtl
	s.buf[4] = &r.RefreshTokenTtl
	s.buf[5] = &r.TenantID
	s.buf[6] = &r.ManifestVersion
	s.buf[7] = &r.Kind
	s.buf[8] = &r.Status
	s.buf[9] = &r.Slug
	s.buf[10] = &r.Name
	s.buf[11] = r.ClientSecretHash.Ptr()
	s.buf[12] = &r.RedirectUris
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "applications", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 1:
			args = append(args, m.row.AccessTokenTtl)
		case 2:
			args = append(args, m.row.RefreshTokenTtl)
		case 3:
			args = append(args, m.row.TenantID)
		case 4:
			args = append(args, m.row.ManifestVersion)
		case 5:
			args = append(args, m.row.Kind)
		case 6:
			args = append(args, m.row.Status)
		case 7:
			args = append(args, m.row.Slug)
		case 8:
			args = append(args, m.row.Name)
		case 9:
			args = append(args, m.row.ClientSecretHash.Arg())
		case 10:
			args = append(args, m.row.RedirectUris)
		case 11:
			args = append(args, m.row.BackchannelLogoutURI.Arg())
		case 12:
