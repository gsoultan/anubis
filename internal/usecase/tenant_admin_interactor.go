...
type KeyRotator interface {
	PrepareKey(ctx context.Context, purpose string) (*repository.KeyRecord, error)
}
...
type tenantAdminInteractor struct {
	...
	realms   repository.RealmAdminRepository
	apps     repository.ApplicationRepository
	routes   repository.RouteRepository
	auditRd  repository.AuditReadRepository
...
func NewTenantAdminInteractor(
	...
	return &tenantAdminInteractor{
		guard: newAdminGuard(authz), tenants: tenants, realms: realms,
...
func (u *tenantAdminInteractor) ListTenants(ctx context.Context) ([]repository.TenantRef, error) {
...
func (u *tenantAdminInteractor) CreateTenant(ctx context.Context, slug, name string) (*repository.TenantRef, error) {
	p, err := u.guard.require(ctx, "anubis:tenant:admin")
	if err != nil {
		return nil, err
	}
	if !domain.ValidSlug(slug) {
		return nil, domain.ErrInvalidArgument.With("slug", slug)
	}
...
func (u *tenantAdminInteractor) ListRealms(ctx context.Context) ([]repository.RealmRecord, error) {
...
func (u *tenantAdminInteractor) CreateRealm(ctx context.Context, r repository.RealmRecord) (*repository.RealmRecord, error) {
	p, err := u.guard.require(ctx, "anubis:realm:admin")
	if err != nil {
		return nil, err
	}
	if !domain.ValidCode(r.Code) {
		return nil, domain.ErrInvalidArgument.With("code", r.Code)
	}
...
func (u *tenantAdminInteractor) UpdateRealm(ctx context.Context, r repository.RealmRecord) (*repository.RealmRecord, error) {
	p, err := u.guard.require(ctx, "anubis:realm:admin")
	if err != nil {
		return nil, err
	}
...
func (u *tenantAdminInteractor) realmByID(ctx context.Context, tenantID, id string) (*repository.RealmRecord, error) {
...
func (u *tenantAdminInteractor) ListRealmCategories(ctx context.Context, realmID string) ([]repository.RealmCategoryRecord, error) {
...
func (u *tenantAdminInteractor) CreateRealmCategory(ctx context.Context, c repository.RealmCategoryRecord) (*repository.RealmCategoryRecord, error) {
	p, err := u.guard.require(ctx, "anubis:realm:admin")
	if err != nil {
		return nil, err
	}
...
func (u *tenantAdminInteractor) ListApplications(ctx context.Context) ([]repository.ApplicationRecord, error) {
	p, err := u.guard.require(ctx, "anubis:identity:read")
	if err != nil {
		return nil, err
	}
...
func (u *tenantAdminInteractor) CreateApplication(ctx context.Context, a repository.ApplicationRecord) (*repository.ApplicationRecord, string, error) {
	p, err := u.guard.require(ctx, "anubis:application:admin")
	if err != nil {
		return nil, "", err
	}
	if !domain.ValidSlug(a.Slug) {
		return nil, "", domain.ErrInvalidArgument.With("slug", a.Slug)
	}
	clientSecret := ""
	if a.Kind == "server" || a.Kind == "service" {
		s, serr := secret.New(32)
		if serr != nil {
			return nil, "", domain.ErrInternal.Wrap(serr)
		}
		clientSecret = s
		a.ClientSecretHash = hexEncode(secret.Hash(s))
	}
...
func (u *tenantAdminInteractor) UpdateApplication(ctx context.Context, a repository.ApplicationRecord) (*repository.ApplicationRecord, error) {
	p, err := u.guard.require(ctx, "anubis:application:admin")
	if err != nil {
		return nil, err
	}
...
func (u *tenantAdminInteractor) RotateClientSecret(ctx context.Context, applicationID string) (string, error) {
	...
	if err := u.apps.SetClientSecretHash(ctx, p.TenantID, applicationID, hexEncode(secret.Hash(s))); err != nil {
		return "", err
	}
...
func (u *tenantAdminInteractor) ListRoutePolicies(ctx context.Context, applicationSlug string) ([]repository.RoutePolicyRecord, error) {
	p, err := u.guard.require(ctx, "anubis:identity:read")
	if err != nil {
		return nil, err
	}
	...
	if err != nil {
		return nil, domain.ErrNotFound.With("application", applicationSlug)
	}
...
func (u *tenantAdminInteractor) QueryAudit(ctx context.Context, q repository.AuditQuery) ([]repository.AuditRecord, string, error) {
...
func (u *tenantAdminInteractor) ListSigningKeys(ctx context.Context) ([]repository.KeyRecord, error) {
...
func (u *tenantAdminInteractor) RotateSigningKey(ctx context.Context, purpose string) (*repository.KeyRecord, error) {
